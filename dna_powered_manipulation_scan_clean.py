...
try:
    ...
    print(f"  DNA systems not available: {e}")
...
class DNAPoweredManipulationScanner:
    ...
    def scan_directory(self, target_dir: str = "backend/app"):
        ...
        print(f"  Files with violations: {self.results['files_with_violations']}")
    ...
    def _print_report(self):
        ...
        print(f"\n  TOTAL VIOLATIONS: {self.results['total_violations']}")
        ...
        if manipulation_rate == 0:
            ...
            print("  VERDICT: GOOD - Some files need attention")
        elif manipulation_rate < 30:
            print("  VERDICT: NEEDS WORK - Significant manipulation detected")
        else:
