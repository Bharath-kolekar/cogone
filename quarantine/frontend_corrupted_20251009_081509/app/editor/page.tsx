...
// import { initializeVoiceAIIntegration } from '@/services/voice-ai-integration' // Removed - service deleted
...
export default function EditorPage() {
  ...
  useEffect(() => {
    ...
    if (voiceDictation.isSupported) {
      ...
      // initializeVoiceAIIntegration(voiceDictation, commandMapper) // Removed - service deleted
    }
